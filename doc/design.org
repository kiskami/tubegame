...
((xs, ys, zs) ; elõször a tér méretei - a mátrix dimenziói x, y, z koordináták mentén
 ...
 (((1 :rot (xr,yr,zr) :sta :cel :ast 1 :ss 1 :pa 1 :wea 1 :spe 5 :tur 1 :ene 1 ) nil ...)(...)) ;  kockanyílások száma, forgatások a tengelyek mentén fokban
 (...)
 ...
...
#+BEGIN_SRC lisp
(1 :rot (xr,yr,zr) :sta :cel :ast 1 :ss 1 :pa 1 :wea 1 :spe 5 :tur 1 :ene 1 )
#+END_SRC
...
- az elsõ <szám> - kockanyílások száma, utána tetszõleges sorrendben a többi, nem kötelezõen
  ...
  - 5 - öt nyílás
  - 6 - hat nyílás
- :rot (xr,yr,zr) - kocka forgatása tengelyek mentén, a megadott fokokkal
- :sta - startpozíció van itt
- :cel - célpozíció van itt
- :ast <szám> - aszteroida/mezõ van itt
...
Ha hiányzik, akkor a default értékek lesznek használva.
...
3. ûrhajó fegyvere energiaszint kezdõértéke
